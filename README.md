...
## **サービスの差別化ポイント・推しポイント**
いくつかの類似サービスはありますが以下の点で差別化しております。
  **類似サービス** <br>
    ・BandLab : 音楽制作とコラボのプラットフォーム。他のミュージシャンとつながり、作品の公開や共同作業が可能<br>
    ・Vampr : プロ志向のミュージシャン向けネットワーキングアプリ。音楽制作とコラボをサポート<br>
    ・Co-Writing Studio : 曲作りのコラボツール。仲間同士でアイデアを共有しながら楽曲制作を行うプラットフォーム<br>
